# -*- coding: utf-8 -*-
#
# ConKit documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath("../conkit"))
...
project = u'ConKit'
copyright = u'2016, Felix Simkovic'
...
version = conkit._version.__version__
# The full version, including alpha/beta/rc tags.
release = conkit._version.__version__
