...
Similar to the example on plotting a contact map, this is something you will almost certainly do every single time you obtain a contact prediction. Head over to the :ref:`example_plotting_a_map` in case you haven't looked at this.
